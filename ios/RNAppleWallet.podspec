#
#  Be sure to run `pod spec lint react-native-wallet.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Sean Wcisel"
  # s.authors            = { "Sean Wcisel" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Sean Wcisel"
